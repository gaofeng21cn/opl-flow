...
| Doc | Role | Boundary |
| --- | --- | --- |
| [Capability governance](./capability-governance.md) | Authority map for Skills, Plugins, MCP, CLI, Standard, and Full convergence | Policy declares; Framework executes lifecycle; App consumes projections |
