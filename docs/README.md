...
plugin manifest, installer scripts, bundled skills, companion checker output,
tests, and repo-native verification commands.
...
| Doc | Role | Boundary |
| --- | --- | --- |
| [Compatibility and positioning](./compatibility.md) | OPL Flow positioning against Codex, Superpowers, Ponytail, Trellis, Claude Code, and GitHub Agentic Workflows | Human-readable positioning; not OPL App/runtime/domain readiness |
