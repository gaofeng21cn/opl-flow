---
name: book-ddia
description: "Use when data correctness depends on distributed or evolving state: replication, partitioning, transaction isolation, schema/message evolution, event replay, materialized views, durable logs, or rebuilding derived data. Do not trigger for ordinary local storage, cache use, SQLite queries, or generic freshness checks."
---
