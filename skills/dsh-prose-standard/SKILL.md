...
description: Use when writing, reviewing, restoring, or trimming developer-facing prose across Markdown, JSDoc, comments, prompts, descriptions, diagnostics, tests, and visible technical strings while preserving complete contracts.
---

# Apply The Prose Standard

Use `$opl-doc` for authority and current-state alignment. Confirm the requested
