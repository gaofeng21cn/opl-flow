...
description: Use only when the user asks to recover a Codex task that is missing, interrupted, hidden, or unreadable after a restart or failure. Do not use for visible-task navigation or general history.
---
