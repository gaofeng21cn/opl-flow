...
Use the `software-development` router as the owner. This reference is review guidance,
...
- Review changed docs, comments, prompts, diagnostics, and visible strings with
  `docs/prose.md`; passing mechanical gates do not prove semantic quality.
