...
description: Use before pushing, force-with-lease publishing, marking a change ready, or claiming checks pass; selects the smallest sufficient evidence for the complete outgoing diff and verifies the remote ref after publication.
---

# Select Pre-Push Evidence

Use `$develop-and-deliver` as the owner. This Skill selects evidence for an
