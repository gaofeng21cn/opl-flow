---
name: codex-app-owner-migration
description: Use when moving a durable OPL task's execution owner to another machine and the replacement must be a native, user-visible Codex App task rather than a headless CLI process.
---
...
Use this Skill together with `$opl-fleet` and the existing owner-migration
