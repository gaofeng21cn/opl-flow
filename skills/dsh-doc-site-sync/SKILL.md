...
description: Use when a repository publishes documentation through a generated site or docs manifest; update the canonical source, projection mapping, navigation, links, and site checks without editing generated output.
---

# Synchronize A Documentation Site

Use `$opl-doc` for document ownership and meaning. Discover the target
