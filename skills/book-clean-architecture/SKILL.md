...
description: "Use when the user explicitly asks for the Clean Architecture lens on dependency direction, policy-owned ports, plain boundary models, or composition roots."
---
