...
REQUIRED_FILES = (
    ...
    "scripts/opl_fleet_parts/fleet_workflow.py",
...
def check_workflow_policy(repo_root: Path) -> list[str]:
    ...
    expected_incremental_fast_path = {
        ...
        "responsibility_registry": {
            "state_owner": "private_supervisor_memory_cursor_location",
            "classification_values": ["personal_responsibility", "other_owner", "intake_review"],
            "evidence_required": ["source_or_thread_identity", "authority_or_delegation", "current_owner", "write_set_boundary", "last_verified_at"],
            "admission_rule": "only_personal_responsibility_enters_beads_linear_or_dashboard_counts",
            "other_owner_rule": "retain_as_associated_evidence_only;exclude_from_personal_ledger_counts_and_actions",
            "ambiguous_rule": "retain_intake_review_without_creating_or_projecting_objective",
            "continuation_authority_rule": "generic_continue_advances_current_owner_only;fresh_read_existing_owner_before_action;does_not_authorize_high_risk_mutation_or_owner_transfer",
            "refresh_trigger": "every_phase_a_and_on_user_or_owner_direction_change",
        },
        "linear_detection": {
